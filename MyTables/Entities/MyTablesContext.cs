...
{
    public class MyTablesContext : DbContext
    {
        public MyTablesContext(DbContextOptions<MyTablesContext> options) : base(options)
        { 
        ...
        public DbSet<State> WorkItemStates { get; set; }
